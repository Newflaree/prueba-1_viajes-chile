...
5. Gestionar el código fuente utilizando Github: (2 Puntos)
  ...
  * Implementar la creación de repositorio remoto en Github para el versionamiento del proyecto.5- Gestionar el código fuente utilizando Github: (2 Puntos)
  * Inicializar GIT para versionar el proyecto localmente, realizando 5 o más commits.
  * Implementar la creación de repositorio remoto en Github para el versionamiento del proyecto.5- Gestionar el código fuente utilizando Github: (2 Puntos)
  * Inicializar GIT para versionar el proyecto localmente, realizando 5 o más commits.
  * Implementar la creación de repositorio remoto en Github para el versionamiento del proyecto.5- Gestionar el código fuente utilizando Github: (2 Puntos)
